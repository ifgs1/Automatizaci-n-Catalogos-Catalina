 ...
 * <ul>
 *   <li>{@link arquitectura.impl.InsertImpl#getTable <em>Table</em>}</li>
 *   <li>{@link arquitectura.impl.InsertImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InsertImpl extends MinimalEObjectImpl.Container implements Insert {
	...
	protected EClass eStaticClass() {
		return ArquitecturaPackage.Literals.INSERT;
	}
	...
	public void setTable(String newTable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArquitecturaPackage.INSERT__TABLE, oldTable, table));
	}
	...
	public void setValues(String newValues) {
		...
		values = newValues;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArquitecturaPackage.INSERT__VALUES, oldValues, values));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArquitecturaPackage.INSERT__TABLE:
				return getTable();
			case ArquitecturaPackage.INSERT__VALUES:
				return getValues();
		}
