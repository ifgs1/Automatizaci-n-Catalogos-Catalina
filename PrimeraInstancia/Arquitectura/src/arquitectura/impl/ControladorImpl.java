 ...
 * <ul>
 *   <li>{@link arquitectura.impl.ControladorImpl#getNombre <em>Nombre</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ControladorImpl extends MinimalEObjectImpl.Container implements Controlador {
	...
	protected EClass eStaticClass() {
		return ArquitecturaPackage.Literals.CONTROLADOR;
	}
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArquitecturaPackage.CONTROLADOR__NOMBRE, oldNombre, nombre));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArquitecturaPackage.CONTROLADOR__NOMBRE:
				return getNombre();
		}
